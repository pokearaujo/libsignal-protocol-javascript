module.exports = function (libsignal = {}, Internal = {}) {
  ...
  SessionBuilder.prototype = {
          ...
          return this.storage
            ...
            .then(
              function (session) {
                ...
                return this.storage.loadSession(address).then(
                  function (serialized) {
                    var record;
        ...
        .then(
          function () {
            ...
            if (signedPreKeyPair === undefined) {
              ...
              if (
                session !== undefined &&
                session.currentRatchet !== undefined
              ) {
                return;
              } else {
                throw new Error(
    ...
    initSession: function (
      ...
      return this.storage.getIdentityKeyPair().then(
        function (ourIdentityKey) {
          ...
          if (
            ...
            theirEphemeralPubKey === undefined
          ) {
            ...
            .then(function (ecRes) {
              ...
              if (
                ...
                return Internal.crypto
                  .ECDHE(theirEphemeralPubKey, ourEphemeralKey.privKey)
              ...
              function (masterKey) {
                ...
                if (isInitiator) {
                  ...
                  return Internal.crypto.createKeyPair().then(
                    function (ourSendingEphemeralKey) {
                      session.currentRatchet.ephemeralKeyPair =
                        ourSendingEphemeralKey;
                      return this.calculateSendingRatchet(
                        session,
                        theirSignedPubKey
                      ).then(function () {
                        return session;
